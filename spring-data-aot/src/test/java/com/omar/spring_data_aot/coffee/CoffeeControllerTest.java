...
class CoffeeControllerTest {
    ...
    void shouldFilterCoffeesBySizeAndPrice() {
        ...
        when(coffeeRepository.findBySizeAndPriceGreaterThan(Size.LARGE, new BigDecimal("5.00")))
            .thenReturn(coffees);
    ...
    void shouldReturnAffordableCoffees() {
        ...
        when(coffeeRepository.findAffordableCoffeesBySize("LARGE", new BigDecimal("6.00")))
            .thenReturn(coffees);
